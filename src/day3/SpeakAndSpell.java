...
String awnser =		JOptionPane.showInputDialog("spell it");
		// 3. If the user spelled the word correctly, speak "correct"
	if (awnser.equals("mandlebrot")){speak("correct you wont die");
		// 4. Otherwise say "wrong"
	}	else {speak("wrong even my dog can spell that M ,A ,N ,D ,L ,E ,B ,R ,O ,T");}}
